...
describe('formatRelativeTime', () => {
  ...
  it('should return null', () => {
    const time = '2020-08-09T16:28:06.330Z';
    const currTime = new Date('2020-08-09T16:25:06.330Z');
  ...
  it('should return brief', () => {
    const time = '2020-08-09T16:28:06.330Z';
    const time2 = '2020-08-09T16:27:56.330Z';
    const currTime = new Date('2020-08-09T16:28:06.330Z');
  ...
  it('should return time difference in secs', () => {
    const time = '2020-08-09T16:28:56.330Z';
    const currTime = new Date('2020-08-09T16:29:45.330Z');
  ...
  it('should return time difference in mins', () => {
    const time = '2020-08-09T16:28:06.330Z';
    const currTime = new Date('2020-08-09T16:29:06.330Z');
  ...
  it('should return time difference in hours', () => {
    const time = '2020-08-09T16:28:06.330Z';
    const time2 = '2020-08-08T23:28:06.330Z';
    const currTime = new Date('2020-08-09T23:26:06.330Z');
  ...
  it('should return time difference in days', () => {
    const time = '2020-08-07T20:28:06.330Z';
    const time2 = '2020-08-08T23:28:06.330Z';
    const currTime = new Date('2020-08-09T23:28:06.330Z');
  ...
  it('should return formatted date', () => {
    const time = '2020-08-01T23:28:06.330Z';
    const currTime = '2020-08-09T21:26:06.330Z';
